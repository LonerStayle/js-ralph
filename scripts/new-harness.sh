...
echo "next:"
echo "  cd $DEST"
echo "  edit .claude/scripts/{deploy,smoke-test}.sh        # 도메인에 맞게"
echo "  edit .claude/config/verify-checklist.md            # 도메인 검증 기준"
echo "  edit CLAUDE.md (도메인 섹션: 무엇/입력/산출물/종료조건)"
echo "  /ralph-deploy → /ralph-cycle-start"
echo
echo "remote (선택):"
